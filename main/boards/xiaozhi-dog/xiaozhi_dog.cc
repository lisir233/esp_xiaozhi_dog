...
#define TAG "XiaozhiDogBoard"

class XiaozhiDogBoard : public WifiBoard {
private:
    ...
    void InitializeIot() {
        ...
        thing_manager.AddThing(iot::CreateThing("LED_Lamp"));
        thing_manager.AddThing(iot::CreateThing("Robdog"));
    }
